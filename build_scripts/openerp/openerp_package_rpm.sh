...
gunzip emr-functional-tests/dbdump/odoo_backup.sql.gz
mv emr-functional-tests/dbdump/odoo_backup.sql bahmni_package/bahmni-erp/resources/odoo_demo_dump.sql
#Working Directory bahmni_package
