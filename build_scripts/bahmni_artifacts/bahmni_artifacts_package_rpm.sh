...
cd bahmni-playbooks && ansible-playbook --syntax-check all.ymlconcat-config.yml incr-mysqldbbackup.yml incr-mysqldbrestore.yml incr-postgresdbbackup.yml incr-postgresdbrestore.yml backup-artifacts.yml restore-artifacts.yml mysql-replication.yml postgres-replication.yml -i local && cd ..
